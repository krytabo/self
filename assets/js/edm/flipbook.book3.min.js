...
FLIPBOOK.Book3 = function (t, e, i) {
    ...
    for (var r = 0; r < i.numPages; r++)(n = new FLIPBOOK.Page3(this, r, i.pages[r].src, i.pages[r].htmlContent)).hideHtml(), this.pagesArr.push(n), this.$centerContainer.append(n.$wrapper), this.flippedright++;
    ...
    var l = this.options.rightToLeft ? -this.model.bookW : 0;
    this.scroll.scrollTo(l, 0, 300)
