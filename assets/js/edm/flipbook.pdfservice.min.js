...
FLIPBOOK.PdfService = function (i, e, g) {
    var h = this;
    this.pdfDocument = i, this.pdfInfo = i._pdfInfo, this.numPages = this.pdfInfo.numPages, this.webgl = "webgl" == g.viewMode && 1 < this.numPages, this.options = g, this.main = g.main, this.model = e, this.pages = [], this.thumbs = [], this.canvasBuffer = [], this.viewports = [], this.textContents = [], this.pdfPages = [], this.pdfAnnotations = [], this.eventBus = new EventBus, this.linkService = new PDFLinkService({
